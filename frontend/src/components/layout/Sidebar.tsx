    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-3 px-4 h-16 border-b border-surface-700/50">
                ...
                {!collapsed && (
                    <span className="text-lg font-bold gradient-text tracking-tight">NovaPanel</span>
                )}
            </div>
            ...
            <button
                ...
                className="flex items-center justify-center h-12 border-t border-surface-700/50 text-surface-200/50 hover:text-white hover:bg-surface-700/30 transition-colors"
            >
